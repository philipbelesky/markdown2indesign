...
class Markdown(object):
    ...
    def convert(self, text):
        ...
        text = self._indesign_sanitise(text)
    ...
    def _add_footnotes(self, text):
        if self.footnotes:
            ...
            for i, id in enumerate(self.footnote_ids):
                ...
                backlink = ''
                # 11-01-24 removing backlinks feature to make printable
    ...
    def _indesign_sanitise(self, text):
        text = '<root>' + text + '</root>'
        ...
        text = text.replace('</p></blockquote>', '</blockquote>')
...
def main(argv=None):
    ...
    parser = optparse.OptionParser(prog="markdown2indesign", usage=usage,
